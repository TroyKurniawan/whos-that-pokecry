  ...
  return (
    <div className="h-3/4 grid justify-center content-center">
      ...
      <div className="flex justify-between">
        ...
        <button className="w-1/2 p-2 m-4 border border-gray-500 text-gray-500 rounded-xl  text-lg hover:border-gray-600 hover:text-gray-600 active:border-gray-700 active:text-gray-700 flex content-center justify-center items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
